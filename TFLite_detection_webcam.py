        ...
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            if pause == 1:
                if detected_outside == True:
                    cv2.putText(frame,'Crowd Outside',(int(IM_WIDTH*.1),int(IM_HEIGHT*.5)),font,3,(0,0,0),7,cv2.LINE_AA)
                    cv2.putText(frame,'Crowd Outside!',(int(IM_WIDTH*.1),int(IM_HEIGHT*.5)),font,3,(95,176,23),5,cv2.LINE_AA)
